				...
				<table id="datatable1" class="table table-striped table-hover">
					<thead>
						<tr>
							...
							<th><b>Proceso-subproceso</b></th>
							<th><b>Inspeccionado</b></th>
                            <th><b>inspector</b></th>
					...
					<tbody>
						@foreach ($actividadesPlan as $actividad)
						 <tr>
							<td>
                             @php
    $actividadesP= explode('/',$actividad->Actividades)
    
@endphp  
<ol>
@for ($i=0;$i<count($actividadesP);$i++)
 
 <li> {{$actividadesP[$i]}}</li>
...
@endfor
							...
							<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group">
											@if($estado == 'usuarioWS')
												{{ Form::select('IdPersonalInspector', $personalWS->pluck('Name' , 'IdUserLDAP'), null, ['class' => 'form-control', 'id' => 'IdPersonalInspector']) }}
											@else
												{{ Form::select('IdPersonalInspector',$personalWS->pluck('Name' , 'IdUserLDAP'), null, ['class' => 'form-control', 'id' => 'IdPersonalInspector']) }}
											@endif
	...
	@section('addjs')
        ...
        $('#IdCriterios').change(function(event){
console.log('change')
let  url="https://auditorigefa.fac.mil.co/criteriosAuditoria/"
//let  url="http://localhost/auditorfac/public/criteriosAuditoria/";
