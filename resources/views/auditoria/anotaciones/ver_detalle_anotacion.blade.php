...
<div class="col-lg-12">
	...
	<div class="table-responsive">
		<table id="datatable1" class="table table-striped table-hover">
			<thead>
				<tr>
					<th><b>Causa del Incumplimiento</b></th>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									...
									<label for="CausaRaiz">Causa del Incumplimiento*</label>
								</div>
							</div>
						</div>
						{{--<div class="row">
						...
						<div class="row">
							<div class="table-responsive" style="margin:20px">
								<table id="datatable1" class="table table-striped table-hover table-responsive">
									<thead>
										<tr>
											<th style="width: 300px;"><b>Actividad/Descripción</b></th>
											...
											<th style="width: 120px;"><b>Fecha Terminación</b></th>
