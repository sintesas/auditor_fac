			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<label for="Codigo">Tipo Inspección</label>
					</div>
				</div>	
				<div class="col-sm-6">
					<div class="form-group">
						<input type="text" class="form-control" id="Sigla" name="Sigla" required value="{{old('Sigla', $tipoAuditoria->Sigla)}}">
