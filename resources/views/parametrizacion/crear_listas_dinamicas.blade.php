...
@section('content')
	...
	@section('card-content')
		...
		@section('card-title')
			{{Breadcrumbs::render('crear_listas_dinamicas')}}
		@endsection()
		...
		<div class="card-body floating-label">
			...
			<div class="form-group">
				<div class="row">
						...
						<div class="col-sm-6">
							<button type="button" onclick="window.location='{{ route("listas_dinamicas.index") }}'" style="" class="btn btn-danger btn-block">Cancelar</button>
						</div>
					</div>
				</div>
			</div>
