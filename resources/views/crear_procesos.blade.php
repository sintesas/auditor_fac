              ...
              <div class="col-lg-12">
                <div class="table-responsive">
                  <table id="datatable1" class="table table-striped table-hover">
                    <thead>
                      <tr>
                        <th style="width: 150px;"><b>Nombre proceso</b></th>
                        <th style="width: 150px;"><b>Nombre Sub-Proceso</b></th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div class="col-sm-4">
                            {!! Form::open(['route' => ['procesosAuditoria.destroy', $item->IdProceso], 'method' => 'DELETE']) !!}
                            {!!Form::submit('x', ['class' => 'btn btn-danger deleteButton']) !!}
                            {!! Form::close() !!}
                          </div>
                        @endif
                          <div class="col-sm-6">
                            <a href="{{route('procesosAuditoria.edit', $item->IdProceso) }}" class="btn btn-primary btn-block editbutton">
...
<div id="id1" class="modal" style="padding-top:80px;">
  ...
  <div class="modal-content" style="width:60%;">
    ...
    <div class="card-head style-primary">
      <header>Crear Nuevo Proceso</header>
    ...
    <div class="card">
      <div class="card-body floating-label">
        ...
        {!! Form::open(array('route' => 'procesosAuditoria.store')) !!}
