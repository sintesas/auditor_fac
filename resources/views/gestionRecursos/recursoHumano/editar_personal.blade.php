...
@section('content')
	...
	@section('card-content')
		...
		@section('form-tag')
			...
			{!! Form::model($personal, ['route' => ['personal.update', $personal->IdPersonal], 'method' => 'PUT', 'files' =>true ]) !!}
		...
		@section('card-title')
			{{Breadcrumbs::render('editar_personal')}}
		@endsection()
                   ...
                   <div class="row">
                        <div class="col-sm-4">
                            <div class="foto-personal">
                                ...
                                <img id="image_upload_preview" src="{{URL::asset('secad/Personal/Fotos/' . $personal->Cedula . '/' . $personal->Foto)}}" alt="profile Pic">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="Nombres" name="Nombres" required value="{{old('Nombres', $personal->Nombres)}}">
                                <label for="Nombres">Nombres</label>
                            </div>
                        </div>                        
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="Apellidos" name="Apellidos" required value="{{old('Apellidos', $personal->Apellidos)}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <input type="text" class="form-control" id="Cedula" name="Cedula" required value="{{old('Cedula', $personal->Cedula)}}">
                                <label for="Cedula">Número de Documento</label>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <input type="text" class="form-control" id="LugarExpedicion" name="LugarExpedicion" required value="{{old('Lugarexpedicion', $personal->Lugarexpedicion)}}">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                <input type="text" class="form-control" id="LugarNacim" name="LugarNacim" required value="{{old('LugarNacim', $personal->LugarNacim)}}">
                            ...
                            <div class="form-group">
                                <div class="input-group date" id="demo-date-format">
                                    <div class="input-group-content">
                                        <input type="text" class="form-control" id="FechaNacim" name="FechaNacim" required value="{{old('FechaNacim', $personal->FechaNacim)}}">
                        ...
                        <div class="col-xs-3">
                            <div class="form-group">
                                <input type="text" class="form-control" id="Edad" name="Edad" required readonly value="{{old('Edad', $personal->Edad)}}">
                                <label for="Edad"> Edad </label>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <input type="Email" class="form-control" id="Email" name="Email" required value="{{old('Email', $personal->Email)}}">
                     ...
                     <div class="row">
                         <div class="col-sm-3">
                            <div class="form-group">
                                <input type="Email" class="form-control" id="EmailPersonal" name="EmailPersonal" required value="{{old('EmailPersonal', $personal->EmailPersonal)}}">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group floating-label">
                                {{ Form::select('IdProceso', $procesos->pluck('Proceso' , 'IdProceso'), null, ['class' => 'form-control', 'id' => 'IdProceso']) }}
                                {{ Form::label('IdProcesoLabel', 'Proceso')}}
                            </div>
                        </div>
                    </div> 
                </div><!--end .card-body -->
            ...
            <div class="card" id="infoCivil">
                ...
                <div class="card-body">                                                                                
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="DependeciaFacultad" name="DependeciaFacultad" value="{{old('DependeciaFacultad', $personal->DependeciaFacultad)}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="Escolaridad" name="Escolaridad" value="{{old('Escolaridad', $personal->Escolaridad)}}">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="Experiencia" name="Experiencia">{{old('Experiencia', $personal->Experiencia)}}</textarea>
                        ...
                        <div class="col-xs-6">
                            <div class="form-group">
                                <div class="input-group date" id="demo-date-format">
                                    <div class="input-group-content">
                                        <input type="text" class="form-control" id="FechaIncorporacionSecad" name="FechaIncorporacionSecad" value="{{old('FechaIncorporacionSecad', $personal->FechaIncorporacionSecad)}}">
                    ...
                    <div class="row">                        
                        ...
                        <div class="col-xs-4">
                            <div class="form-group">
                                <input type="text" class="form-control" id="Celular" name="Celular" value="{{old('Celular', $personal->Celular)}}">
                                <label for="Celular">Celular</label>
                            </div>
                        </div>                        
                        <div class="col-xs-4">
                            <div class="form-group">
                                <input type="text" class="form-control" id="Fijo" name="Fijo" value="{{old('Fijo', $personal->Fijo)}}">
                                <label for="Fijo">Fijo</label>
                            </div>
                        </div>
                        <div class="col-xs-4">
                            <div class="form-group">
                                <input type="text" class="form-control" id="Oficina" name="Oficina" value="{{old('Oficina', $personal->Oficina)}}">
                    ...
                    <div class="row">                        
                        <div class="col-xs-4">
                            <div class="form-group">
                                <input type="text" class="form-control" id="PaisResidencia" name="PaisResidencia" value="{{old('PaisResidencia', $personal->PaisResidencia)}}">
                        ...
                        <div class="col-xs-4">
                            <div class="form-group">
                                <div class="input-group date" id="demo-date-format">
                                <div class="input-group-content">
                                    <input type="text" class="form-control" id="FechaTermino" name="FechaTermino" value="{{old('FechaTermino', $personal->FechaTermino)}}">
                    ...
                    <div class="row">                        
                        ...
                        <div class="col-xs-6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="DireccionResi" name="DireccionResi" value="{{old('DireccionResi', $personal->DireccionResi)}}">
                                <label for="DireccionResi">Direccion Residencia</label>
                            </div>
                        </div>  
                        <div class="col-xs-6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="Barrio" name="Barrio" value="{{old('Barrio', $personal->Barrio)}}">
            ...
            <div class="card" id="infoMilitar">
                ...
                <div class="card-body">  
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <div class="form-group">
                                <input type="text" class="form-control" id="CodigoMilitar" name="CodigoMilitar" value="{{old('CodMilitar', $personal->CodMilitar)}}">
                                <label for="CodigoMilitar">Codigo Militar</label>
                            </div>
                        </div>
                        <div class="col-xs-3">
                            <div class="form-group">
                                <input type="text" class="form-control" id="NFolio" name="NFolio" value="{{old('NoFolioVida', $personal->NoFolioVida)}}">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group">
                                <div class="input-group date" id="demo-date-format">
                                    <div class="input-group-content">
                                        <input type="text" class="form-control" id="FechaIncorporacion" name="FechaIncorporacion" value="{{old('FechaIncorporacion', $personal->FechaIncorporacion)}}">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group">
                                <div class="input-group date" id="demo-date-format">
                                    <div class="input-group-content">
                                        <input type="text" class="form-control" id="FechaAsense" name="FechaAsense" value="{{old('FechaAsense', $personal->FechaAsense)}}">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                         <div class="col-xs-3">
                            <div class="form-group">
                                {{ Form::select('IdCarreraProfesion', $profesiones->pluck('CarreraProfesion', 'IdCarreraProfesion'), null, ['class' => 'form-control', 'id' => 'IdCarreraProfesionMil']) }}
                                <label for="IdCarreraProfesionMil"> Profesion </label>
                            </div>
                        </div>
                         <div class="col-xs-3">
                            <div class="form-group">
                                {{ Form::select('IdCargo', $cargos->pluck('Cargo', 'IdCargo'), null, ['class' => 'form-control', 'id' => 'IdCargoMil']) }}
                        ...
                        <div class="col-xs-3">
                            <div class="form-group">
                                {{ Form::select('IdNivelCompetencia', $nivelCompetencias->pluck('Denominacion', 'IdNivelCompetencia'), null, ['class' => 'form-control', 'id' => 'IdNivelCompetenciaMil']) }}
                                <label for="IdNivelCompetenciaMil"> Nivel de competencia</label>
                            </div>
                        </div>  
                        
                    </div>
                    <input type="hidden" id="cuerpoId" value="{{$personal->IdCuerpo}}">
                </div>
			</div>
