...
$rolFULL = UsersLDAP::perteneceIGEFA_CEOAF();
?>
		...
		<ul id="main-menu" class="gui-controls">
			...
			<li class="gui-folder">
				...
				<ul>
					...
					@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[1] == true || $gl_perfil[19] == true)
					<li class="gui-folder">
					...
					@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[1] == true || $gl_perfil[11] == true || $gl_perfil[8] == true || $gl_perfil[7] == true)
					<li class="gui-folder">
						...
						<ul>
							...
							<li class="gui-folder">
								...
								<ul>
									@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[1] == true  || $gl_perfil[8] == true || $gl_perfil[7] == true)
							...
							@endif
							@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[1] == true || $gl_perfil[11] == true || $gl_perfil[7] == true || $gl_perfil[8] == true)
							<li class="gui-folder">
							...
							<li class="gui-folder">
								<a href="javascript:void(0);"><span class="title">Dificultades en Servicio</span></a>
								<ul>
									<li><a href="{{route('riesgoprograma.create')}}"><span class="title">Crear Riesgo</span></a></li>
									<li><a href="{{route('riesgoprograma.index')}}"><span class="title">Ver Riesgo</span></a></li>
								</ul>
							</li>
							...
							<li class="gui-folder">
								...
								<ul>
									...
									@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[1] == true || $gl_perfil[7] == true)
									<li><a href="{{route('vistaBalanceo.index')}}"><span class="title">Balanceo Mano<br> de Obra (TDIN)</span></a></li>
									@endif
									@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[1] == true)
									<li><a href="{{route('consultahoraslaboradas.index')}}"><span class="title">H/H ingresadas(TDIN)</span></a></li>
									@endif
					...
					@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[1] == true || $gl_perfil[8] == true || $gl_perfil[7] == true || $gl_perfil[11] == true)
					<li class="gui-folder">
						...
						<ul>
							...
							<li><a href="{{route('cmdProgramasConsultar.index')}}"><span class="title">Información de Diseño </span></a></li>
						</ul>
					</li>
					@endif
			...
			@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[2] == true || $gl_perfil[3] == true || $gl_perfil[10] == true || $gl_perfil[11] == true || $gl_perfil[20] == true || $gl_perfil[21] == true || $gl_perfil[23] == true || $gl_perfil[24] == true)
			...
			<li class="gui-folder">
				...
				<ul>
					...
					<li class="gui-folder">
						...
						<ul>
							@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[2] == true || $gl_perfil[3] == true || $gl_perfil[10] == true || $gl_perfil[24] == true)
								<li><a href="{{route('tipoAuditoria.index')}}"><span class="title">Crear Tipo Inspección </span></a></li>
								
								<li><a href="{{route('procesosAuditoria.index')}}"><span class="title">Crear Procesos</span></a></li>

								<li><a href="{{route('criteriosAuditoria.index')}}"><span class="title">Crear Criterios</span></a></li>

								<li><a href="{{route('auditoria.index')}}"><span class="title">Crear Inspección</span></a></li>
							...
							@else
								<li><a href="{{route('anotacion.index')}}"><span class="title">Anotaciones - Causa Raíz </span></a></li>
							@endif

								<li><a href="{{route('informeInspeccion.index')}}"><span class="title">Crear Informe Inspección </span></a></li>
							@endif
							@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[2] == true || $gl_perfil[3] == true || $gl_perfil[10] == true || $gl_perfil[21] == true || $gl_perfil[23] == true || $gl_perfil[24] == true)

								<li><a href="{{route('actividadesHallazgo.index')}}"><span class="title">Actividades </span></a></li>
						...
						@endif
							<li class="gui-folder">
								...
								<ul>
									@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[2] == true || $gl_perfil[3] == true || $gl_perfil[10] == true || $gl_perfil[24] == true)
									<li><a href="{{route('VistaHHAuditorias.index')}}"><span class="title">Informe H/H <br> Por Auditoria </span></a></li>
								@endif

										<li><a href="{{route('informeplaninspeccionfinal.index')}}"><span class="title"><!--Formato <br>Plan de Inspección-->Plan Inspección Final </span></a></li>


									<li><a href="{{route('informeplanmejora.index')}}"><span class="title">Plan de Mejora <br>(Hallazgo) </span></a></li>

									<li><a href="{{route('informeinspeccionicfr03.index')}}"><span class="title">Informe de <br>Inspección </span></a></li>

									<li><a href="{{route('informeinspeccionicfr08.index')}}"><span class="title">Informe Acciones <br>Correctivas </span></a></li>

									<li><a href="{{route('informeseguimientoconsolidado.index')}}"><span class="title"><!--Seguimiento <br>Consolidado--> FORMATO ANALISIS <br> CAUSA RAIZ </span></a></li>
									@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[2] == true || $gl_perfil[3] == true || $gl_perfil[10] == true || $gl_perfil[24] == true)
					...
					@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[2] == true || $gl_perfil[3] == true || $gl_perfil[10] == true || $gl_perfil[20] == true )
					<li class="gui-folder">
			...
			@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[4] == true || $gl_perfil[6] == true || $gl_perfil[18] == true)
			<li class="gui-folder">
				<a>
				...
				<ul>
					@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[4] == true || $gl_perfil[18] == true)
					<li class="gui-folder">
						...
						<ul>
							...
							<li class="gui-folder">
								...
								<ul>
									...
									<li><a href="{{route('informeareasxcoopindustri.index')}}"><span class="title">Reporte de áreas x <br>cooperación industrial</span></a></li>
									...
									<li><a href="{{route('informedinamicoempresa.index')}}"><span class="title">Informe CIIU</span></a></li>
								</ul>
							</li>
				...
				@endif
					...
					<li class="gui-folder">
						<a href="javascript:void(0);"><span class="title">Control Proyectos</span></a>
						<ul>
							<li><a href="{{route('controlProyectos.index')}}"><span class="title">Crear Proyecto</span></a></li>
							<li class="gui-folder">
								<a href="javascript:void(0);"><span class="title">Informes</span></a>
								<ul>
									<li><a href="{{route('informeControlProyectos.index')}}"><span class="title">Proyectos</span></a></li>
									<li><a href="{{route('informeObservaciones.index')}}"><span class="title">Historial de Observaciones</span></a></li>
								</ul>
							</li>
						</ul>
					</li>
			...
			@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[5] == true || $gl_perfil[14] == true  || $gl_perfil[21] == true)
			<li class="gui-folder">
				<a>
				...
				<ul>
					...
					<li class="gui-folder">
						...
						<ul>
							@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[5] == true || $gl_perfil[14] == true)
							<li class="gui-folder">
						...
						<li><a href="#"><span class="title">Crear Rol</span></a></li>
			...
			@if ($gl_perfil[12] == true || $gl_perfil[13] == true || $gl_perfil[4] == true || $gl_perfil[7] == true || $gl_perfil[18] == true || $gl_perfil[11] == true || $gl_perfil[19] == true || $gl_perfil[1] == true)
			<li class="gui-folder">
				<a>
				...
				@endif
					...
					<li class="gui-folder">
						...
						<ul>
							<li><a href="{{route('PlanCertificacion.index')}}"><span class="title">Informe</span></a></li>
						</ul>
					</li>
