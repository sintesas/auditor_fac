	...
	@section('card-content')
		...
		@section('card-content')
			...
			<div class="card-body floating-label">
				...
				<div class="row">
					<div class="col-sm-12">
						<label for="IdCriterios" style="font-size:17px; color:#3f4c5a; margin:0px; padding:0px">En forma particular</label>
						<div class="form-group" >
							{{ Form::select('IdCriterios', $criterios, null, ['onchange' => "", 'multiple' => 'multiple','class' => 'form-control', 'id' => 'IdCriterios', 'name' => 'IdCriterios[]']) }}
						</div>
					</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<label for="IdTipoAuditoria">Tipo de inspección</label>
						</div>
					</div>
				</div>
