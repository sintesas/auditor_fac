                         ...
                         <table class="table table-responsive-md table-bordered" style="margin: 0;">
                            <tbody>
                               ...
                               <tr>
                                  ...
                                  <td height=30 style="margin:0!important;padding:0px!important;font-size: 12px!important">{{$suplente->grado->Abreviatura}}</td>
                                  ...
                                  <td height=30 style="margin:0!important;padding:0px!important;font-size: 12px!important">{{$suplente->EAC->Especialidad}}</td>
