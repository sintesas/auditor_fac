...
@section('content')
	...
	@section('card-content')
     ...
     width:100%;" >	
			...
			<table border="0">
			<tr><th colspan="3">VALOR TOTAL PRESUPUESTADO</th><td>@if($valorTotal) ${{number_format($valorTotal, 0, '', '.')}}@endif</td></tr>
					<tr><th colspan="3">VALOR PRESUPUESTO CANCELADO</th><td>@if($valorCancelado) ${{number_format($valorCancelado, 0, '', '.')}}@endif</td></tr>
					<tr><th colspan="3">VALOR TOTAL CONTRATADO</th><td>@if($valorTotalContratado) ${{number_format($valorTotalContratado, 0, '', '.')}}@endif</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><th COLSPAN="2">PORCENTAJE CONTRATADO</th><td>{{$porcentajeContratado}} %</td><th></th></tr>
				...
				<table id="example" 
						class="table table-striped table-hover " 
							style="font-size: 9px; width:4000px;" >
