				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="InspeccionadoLugar" name="InspeccionadoLugar" required value="{{old('InspeccionadoLugar', $actividadesInspeccion->InspeccionadoLugar)}}">
							<label for="Actividades">Inspeccionado/Lugar</label>
						...
						<div class="form-group">
							<div class="input-group date" id="demo-date-format">
								<div class="input-group-content">
									<input type="text" class="form-control" id="Fecha" name="Fecha" required value="{{old('Fecha', $actividadesInspeccion->Fecha)}}">
