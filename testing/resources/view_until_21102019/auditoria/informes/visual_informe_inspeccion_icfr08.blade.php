		...
		<div id="">
            ...
            <div id="">
                <section>
                    ...
                    <a href="{{route('informeinspeccionicfr08.edit', $informeinspeccionicfr08R->IdAuditoria) }}" style="width: 150px; font-style: Roboto;" class="btn btn-primary btn-block editbutton pull-left"><span class="fa fa-download">    Descargar PDF</span></a>
                @endforeach
                @else
                  <div class="section-body">
