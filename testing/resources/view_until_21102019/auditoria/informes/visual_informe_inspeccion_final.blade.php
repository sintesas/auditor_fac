...
@section('title')
    Informe Plan Final de Inspección
@endsection()
...
@section('content')
    ...
    @section('card-content')
        ...
        <a href="{{route('informeplaninspeccionfinal.edit', $auditoria->IdAuditoria) }}" style="width: 150px; font-style: Roboto;" class="btn btn-primary btn-block editbutton pull-left"><span class="fa fa-download">    Descargar PDF</span></a>
