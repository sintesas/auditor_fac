        ...
        <input type="hidden" id="IdEmpresa" name="IdEmpresa" value="{{$empresa->IdEmpresa}}">
            ...
            <div id="rootwizard1" class="form-wizard form-wizard-horizontal">
                    ...
                    <div class="tab-content clearfix">
                        ...
                        <div class="col-xs-8">
                            <div class="form-group">
                                {{ Form::select('IdTamanoEmpresa', $tamanoempresa->pluck('TamanoDescripcion', 'IdTamanoEmpresa'), old('IdTamanoEmpresa',  isset($caracteristica->IdTamanoEmpresa) ? $caracteristica->IdTamanoEmpresa : null), ['class' => 'form-control', 'id' => 'IdTamanoEmpresa']) }}
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="materiaprima{{$materia->IdMateriaPrimaComponentes}}">
                                    <td>
                                    ...
                                    <td>
                                        <button class="btn btn-danger btn-delete delete-record-materiaprima" value="{{$materia->IdMateriaPrimaComponentes}}"><span class="glyphicon glyphicon-trash"></span></button>
                                    </td>
                                </tr>
                                @endforeach()
                            </tbody>
