...
@section('content')
	...
	@section('card-content')
		...
		@section('card-title')
			{{-- Informe Inspección IC FR 03 --}}
            {{ Breadcrumbs::render('ver_informeinspeccionicfr03') }}
		@endsection()
		...
		<div id="">
            ...
            <a href="{{route('informeinspeccionicfr03.edit', $auditoria->IdAuditoria) }}" style="width: 150px; font-style: Roboto;" class="btn btn-primary btn-block editbutton pull-left"><span class="fa fa-download">    Descargar PDF</span></a>
        </div>
    </div>
