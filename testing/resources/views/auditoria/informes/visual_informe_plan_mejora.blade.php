                ...
                <section>                   
                    <div class="section-body">
                        ...
                        <div class="row">
                            <!-- Titulo -->
                            <div class="col-xs-12 filaFormulario">
                                <div class="col-xs-12 gris text-center" > TIPO DE ACCION: (Marque con una X el tipo de acción y numerela para establecer un control)  </div>         
                            </div>                            
                        ...
                        <div class="row">                                 
                            <!-- Titulo -->
                            <div class="col-xs-12 filaFormulario">
                                <div class="col-xs-12 gris text-center" > FUENTE (Marque con una X el origen de la No Conformidad Real o Potencial )  </div>         
                            </div>                            
                                
                                <div class="col-xs-12 filaFormulario">
                                    <!-- FILA 1 -->
                                    <ul class="menu-tipoAcc">
                                            <li class="br-solid br-solid">
                                                <div class="col-xs-3 br-solid">
                                                    <input type="checkbox" id="cbox1">
                                                </div>
                                                <div class="col-xs-9 br-solid">
                                                    <div class="col-xs-4">
                                                        INSPECCION:
                                                    </div>    
                                                    <div class="col-xs-8">
                            ...
                            <div class="col-xs-12 filaFormulario table-fixed">
                                <table class="table table-x" id="table1">                 
                                    <tr class="filaFormulario bold">
                                        ...
                                        <th class="gris text-center borderT borderB"> CODIGO DE HALLAZGO <br>(Aplica solo para Inspecciones) </th>
                        ...
                        <div class="row">                                                       
                            <div class="col-xs-12  table-fixed">
                                <table class="table  table-x" id="table1">
                                    ...
                                    <tr>
                                        <th colspan="6" class="gris text-center borderL borderT borderB"> ACCIONES A EJECUTAR </th>
                                    </tr>
                                    
                                    <tr>
                                        <th class="th-x  gris text-center borderL borderB"> No</th>
                                      
                                        <th class="th-x gris text-center borderB"> DEFINICION DE CAUSAS <br>(Adjunte formato de Analisis de Causas IC-FR-10) </th>
                                      
                                        <th class="th-x gris text-center borderB" >ACCION / ACTIVIDAD / TAREA </th>
                                    ...
                                    <tr class="line-b">  
                                        <th>{{$informemejoraR->IdAuditoria}}</th>
                                        <th>{{$informemejoraR->Correccion}}</th>
                                        <th>{{$informemejoraR->IdAuditoria}}</th>
                                        <th>{{$informemejoraR->IdAuditoria}}</th>
                                        <th>{{$informemejoraR->IdAuditoria}}</th>
                                        <th>{{$informemejoraR->IdAuditoria}}</th>
