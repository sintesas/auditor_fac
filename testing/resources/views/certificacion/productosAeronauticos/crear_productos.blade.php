                 ...
                 <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-7">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <textarea class="form-control" id="Funcionamiento" name="Funcionamiento" rows="1"></textarea>
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            <input type="number" class="form-control dollar-mask" id="PrecioCompra" name="PrecioCompra" onKeyPress="return soloNumeros(event)">
                                     ...
                                     <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <label for="PrecioCompra"> Tipo Moneda</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                       <div class="form-group">
                                            <label for="doc">Documentación Tecnica</label>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <textarea class="form-control" id="LugarNacim" name="Observaciones"></textarea>
