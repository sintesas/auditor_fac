...
<div class="">
    ...
    <div id="">
        ...
        <div id="">
            ...
            <a href="{{route('informehistorialprograma.edit', $informeHistorialProgramaR->IdPrograma) }}" style="width: 150px; font-style: Roboto; margin-top: 30px;" class="btn btn-primary btn-block editbutton pull-left"><span class="fa fa-download">    Descargar PDF</span></a>
