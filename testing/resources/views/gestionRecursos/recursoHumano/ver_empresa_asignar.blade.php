				...
				<tr>
					...
					<td>
						...
						{{-- <div class="col-sm-4">
							...
							<button type="button" onclick="window.location='{{ route("asignarusuarioEmpresa.show", $user->id) }}'" class="btn btn-info ink-reaction btn-primary" id="myBtn"><span class="fa fa-plus"></span></button>
