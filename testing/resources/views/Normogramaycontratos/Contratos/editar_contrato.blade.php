				...
				<div class="panel-group" id="accordion1">
					<div class="card panel">
						...
						<div id="accordion1-1" class="collapse in">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="Ordenador" value="{{old('Ordenador', $contratos->Ordenador)}}" name="Ordenador" maxlength="50"  required>
									<label for="Ordenador">Ordenador</label>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group floating-label">
									{{ Form::select('SB',  $Bienyservicio->pluck('NombreSB' , 'SB'), $contratos->BS, ['class' => 'form-control', 'id' => 'SB']) }}
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="Rubro" value="{{old('Rubro', $contratos->Rubro)}}" name="Rubro" maxlength="50" required>
									<label for="Rubro">Rubro</label>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="Subordinal" value="{{old('Subordinal', $contratos->Subordinal)}}" name="Subordinal" maxlength="50" required>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="CodigoClasificacionUNSPSC" value="{{old('CodigoClasificacionUNSPSC', $contratos->CodigoClasificacionUNSPSC)}}" maxlength="50" name="CodigoClasificacionUNSPSC" required>
									<label for="CodigoClasificacionUNSPSC">Codigo Clasificacion UNSPSC</label>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" value="{{old('Recurso', $contratos->Recurso)}}" id="Recurso" name="Recurso" maxlength="50" required>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group floating-label">
{{-- 							   		{{ Form::select('UnidadMedia', $UnidadMedidaCPA->pluck('NombreUnidadMedida' , 'IdUnidadMedida'), null, ['class' => 'form-control', 'id' => 'IdUnidadMedida']) }} --}}
							   		<select name="IdUnidadMedida" class="form-control" id IdUnidadMedida>
							   		@foreach($UnidadMedidaCPA as $UnidadMedia)
							   			<option value="{{$UnidadMedia->IdUnidadMedida}}" @if($contratos->UnidadMedida == $UnidadMedia->IdUnidadMedida) selected="selected" @endif>{{$UnidadMedia->NombreUnidadMedida}}</option>
							   		@endforeach
							   		</select>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<input type="number" class="form-control" id="Cantidad" value="{{old('Cantidad', $contratos->Cantidad)}}" name="Cantidad" required>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="NombreContrato" value="{{old('NombreContrato', $contratos->NombreContrato)}}" maxlength="50" name="NombreContrato" required>
									<label for="NombreContrato">Nombre Contrato</label>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="NumeroContrato" value="{{old('NumeroContrato', $contratos->NumeroContrato)}}" maxlength="50" name="NumeroContrato" required>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="Responsable" value="{{old('Responsable', $contratos->Responsable)}}" maxlength="50" name="Responsable" required>
									<label for="Responsable">Responsable</label>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="Grupo" value="{{old('Grupo', $contratos->Grupo)}}" name="Grupo" maxlength="50" required>
						...
						<div class="row">
							...
							<div class="col-sm-12">
								<div class="form-group">
									<input type="text" class="form-control" id="FuncionarioDECOMEMACO" value="{{old('FuncionarioDECOMEMACO', $contratos->FuncionarioDECOMEMACO)}}" name="FuncionarioDECOMEMACO" required maxlength="50">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="MesCRP" value="{{old('MesCRP', $contratos->MesCRP)}}" name="MesCRP" required maxlength="50">
									<label for="MesCRP">MesCRP</label>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="MesObligacion" value="{{old('MesObligacion', $contratos->MesObligacion)}}" maxlength="50" name="MesObligacion" required>
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="Proveedor" value="{{old('Proveedor', $contratos->Proveedor)}}" maxlength="50" name="Proveedor" required>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="NoCPA" value="{{old('NoCPA', $contratos->NoCPA)}}" name="NoCPA" maxlength="50" required>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									<input type="text" class="form-control" id="PostVenta" value="{{old('PostVenta', $contratos->PostVenta)}}" maxlength="50" name="PostVenta" required >
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									<textarea class="form-control" id="InformesSupervisionAlDia"  name="InformesSupervisionAlDia" rows="1" required>{{$contratos->InformesSupervisionAlDia}}
									</textarea>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="Supervisor" value="{{old('Supervisor', $contratos->Supervisor)}}" maxlength="50" name="Supervisor" required>
						...
						<div class="row">
							<div class="col-sm-6">
								...
								<div class="input-group date" id="demo-date-format">
										<div class="input-group-content">
											<input type="text" class="form-control" id="PlazoEjecucion" value="{{old('PlazoEjecucion', $contratos->PlazoEjecucion)}}" name="PlazoEjecucion" required maxlength="50">
							...
							<div class="col-sm-6">
								<div class="form-group floating-label">
									{{ Form::select('IdEstadoPCA', $EstadoCPA->pluck('NombreEstadoPCA' , 'IdEstadoPCA'), $contratos->EstadoCPA, ['class' => 'form-control', 'id' => 'EstadoPCA']) }}
