				...
				<div class="card">
					<div class="card-body">
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
									<input type="text" class="form-control" id="Number" name="Number" required maxlength="50">
									<label for="Number">Número contrato</label>
								</div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<input type="text" class="form-control" id="NombreContrato" name="NombreContrato" required maxlength="50">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									<input type="text" class="form-control" id="PostVenta" name="PostVenta" required maxlength="50">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<input type="number" step="0.01" class="form-control" id="PorcentajeEjecucion" name="PorcentajeEjecucion" required maxlength="3" >
