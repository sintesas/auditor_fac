		...
		{{-- <script src="{{URL::asset('js/libs/DataTables/extensions/ColVis/js/dataTables.colVis.min.js')}}"></script> --}}
		{{-- <script src="{{URL::asset('js/libs/DataTables/extensions/TableTools/js/dataTables.tableTools.min.js')}}"></script> --}}
		...
		{{-- <script src="{{URL::asset('js/core/demo/DemoDashboard.js')}}"></script> --}}
		{{-- <script src="{{URL::asset('js/core/source/popup.js')}}"></script> --}}
		<script src="{{URL::asset('js/dropdown.js')}}"></script>
		<script src="{{URL::asset('js/libs/sweet/sweetalert.min.js')}}"></script>
