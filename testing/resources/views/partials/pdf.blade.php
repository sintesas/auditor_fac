...
abbr[data-original-title] {
  cursor: help;
  border-bottom: 1px dotted #969c9c;
}
.initialism {
  font-size: 90%;
  text-transform: uppercase;
...
.form-control:focus {
  border-color: #0aa89e;
  outline: 0;
  -webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075), 0 0 8px rgba(10, 168, 158, 0.6);
  box-shadow: inset 0 1px 1px rgba(0,0,0,.075), 0 0 8px rgba(10, 168, 158, 0.6);
}
.form-control:focus {
  border-color: #0aa89e;
  outline: 0;
...
.logoFac,.titulo,.datosFormulario{
    border: solid 1px;
    height: 100%;
    text-align: center;        
}
...
body {
    /*background: #255687;*/
    /*background: #d2f1f7 url(../../img/header-top.png) repeat-x 0 0;*/
