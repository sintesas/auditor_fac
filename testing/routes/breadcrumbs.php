...
// Anotacion
 Breadcrumbs::register('anotacion', function($breadcrumbs){
 	$breadcrumbs->parent('dashboard');
 	$breadcrumbs->push('Tablas Anotación', route('anotacion.index'));
 });
...
Breadcrumbs::register('tipoauditoria', function($breadcrumbs){
 	$breadcrumbs->parent('dashboard');
 	$breadcrumbs->push('Tipo Auditoria', route('tipoAuditoria.index'));
 });

Breadcrumbs::register('editar_tipoAuditoria', function($breadcrumbs){
 	$breadcrumbs->parent('tipoauditoria');
 	$breadcrumbs->push('Editar Tipo Auditoria', route('tipoAuditoria.edit', 'IdTipoAuditoria'));
 });
...
Breadcrumbs::register('auditoria', function($breadcrumbs){
 	$breadcrumbs->parent('dashboard');
 	$breadcrumbs->push('Auditorias', route('auditoria.index'));
 });

Breadcrumbs::register('crear_auditoria', function($breadcrumbs){
 	$breadcrumbs->parent('auditoria');
 	$breadcrumbs->push('Crear Auditoria', route('auditoria.create'));
 });

Breadcrumbs::register('editar_auditoria', function($breadcrumbs){
 	$breadcrumbs->parent('auditoria');
 	$breadcrumbs->push('Editar  Auditoria', route('auditoria.edit', 'IdAuditoria'));
 });
...
Breadcrumbs::register('crear_seguimientocausaraiz', function($breadcrumbs){
 	...
 	$breadcrumbs->push('Crear Seguimiento Causa Raiz', route('seguimientoCausaRaiz.create'));
 });
...
Breadcrumbs::register('informeplanmejora', function($breadcrumbs){
 	$breadcrumbs->parent('dashboard');
 	$breadcrumbs->push('Informes Plan Mejora', route('informeplanmejora.index'));
 });

Breadcrumbs::register('ver_planmejora', function($breadcrumbs){
 	$breadcrumbs->parent('informeplanmejora');
 	$breadcrumbs->push('Informe Plan de Mejora (Hallazgos)', route('informeplanmejora.show', 'informemejora'));
 });
...
Breadcrumbs::register('informeinspeccionicfr03', function($breadcrumbs){
 	$breadcrumbs->parent('dashboard');
 	$breadcrumbs->push('Informes Inspeccion IC FR 03', route('informeinspeccionicfr03.index'));
 });

Breadcrumbs::register('ver_informeinspeccionicfr03', function($breadcrumbs){
 	$breadcrumbs->parent('informeinspeccionicfr03');
 	$breadcrumbs->push('Informe Inspección IC FR 03', route('informeinspeccionicfr03.show', 'audiorias'));
 });
...
Breadcrumbs::register('informeinspeccionicfr08', function($breadcrumbs){
 	$breadcrumbs->parent('dashboard');
 	$breadcrumbs->push('Informe Inspección IC FR 08', route('informeinspeccionicfr08.index'));
 });

Breadcrumbs::register('ver_informeinspeccionicfr08', function($breadcrumbs){
 	$breadcrumbs->parent('informeinspeccionicfr08');
 	$breadcrumbs->push('Informe Inspección IC FR 08', route('informeinspeccionicfr08.show', 'informeinspeccionicfr08'));
 });
...
Breadcrumbs::register('informeseguimientoconsolidado', function($breadcrumbs){
 	$breadcrumbs->parent('dashboard');
 	$breadcrumbs->push('Informe Seguimiento Consolidado', route('informeseguimientoconsolidado.index'));
 });
...
Breadcrumbs::register('ver_informeseguimientoconsolidado', function($breadcrumbs){
 	...
 	$breadcrumbs->push('Informe', route('informeseguimientoconsolidado.show', 'informeseguimientoconsolidado'));
 });
