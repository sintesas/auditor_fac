...
use App\Cluster;
use App\Empresa;
use App\ClusterAfiliado;
use Validator;
use App\DemandaPotencialConsumoRotacion;
use App\DemandaPotencialFactibilidadTecnica;
use App\DemandaPotencialPrioridadUma;
use App\DemandaPotencialValoracionEconomica;
use App\DemandaPotencialValoracionTecnica;
use App\DemandaPotencialOfertaAeronautica;
...
class DemandaPotencialController extends Controller
{
     ...
     public function index(){
        ...
        $demandaspotenciales = \DB::select(\DB::raw('select * from AU_Reg_DemandaPotencial Inner join AU_Mst_Unidades
on AU_Mst_Unidades.IdUnidad = AU_Reg_DemandaPotencial.IdUnidad where Activo=1'));
