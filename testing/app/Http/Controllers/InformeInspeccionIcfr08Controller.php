...
class InformeInspeccionIcfr08Controller extends Controller
{
    ...
    public function show($IdAuditoria)
    {
        ...
        return view ('auditoria.informes.visual_informe_inspeccion_icfr08')
                    ->with('informeinspeccionicfr08', $informeinspeccionicfr08);
    }
    ...
    public function edit($IdAuditoria)
    {
        ...
        return \PDF::loadView('auditoria.informes.pdf_informe_inspeccion_icfr08', ['informeinspeccionicfr08' => $informeinspeccionicfr08])->setOption('disable-smart-shrinking', false)->setOption('margin-top', '0mm')->setOption('lowquality', false)->setOption('page-size', 'A4')->download('informe-inspeccion-empresas.pdf');    
    }
