    ...
    public function index()
    {
        ...
        if (Auth::user()->hasRole('administrador')) {
            ...
            $planesIns = PlanInspeccion::orderBy('IdPlanInspeccion', 'desc')
                ->leftjoin('dbo.AU_Reg_Auditorias', 'dbo.AU_Reg_PlanesInspeccion.IdAuditoria', '=', 'dbo.AU_Reg_Auditorias.IdAuditoria')
                ->leftjoin('dbo.AU_Reg_ActividadesPlanInspeccion as API', 'API.IdPlanInspeccion', '=', 'dbo.AU_Reg_PlanesInspeccion.IdPlanInspeccion')
                ->leftjoin('dbo.AU_Reg_usersLDAP as u', 'u.IdUserLDAP', '=', 'API.IdPersonalInsp')
                ->select('dbo.AU_Reg_PlanesInspeccion.IdPlanInspeccion', 'dbo.AU_Reg_Auditorias.IdAuditoria', 'u.name as InspeccIonado', 'dbo.AU_Reg_Auditorias.Codigo', 'dbo.AU_Reg_PlanesInspeccion.Fecha', 'dbo.AU_Reg_PlanesInspeccion.Observaciones')
                ->groupBy('dbo.AU_Reg_PlanesInspeccion.IdPlanInspeccion', 'dbo.AU_Reg_Auditorias.IdAuditoria', 
'u.name', 'dbo.AU_Reg_Auditorias.Codigo', 
'dbo.AU_Reg_PlanesInspeccion.Fecha', 'dbo.AU_Reg_PlanesInspeccion.Observaciones')->get();
...
return view ('auditoria.ver_plan_inspeccion')->with('planesIns', $planesIns);
            ...
            $planesIns = PlanInspeccion::orderBy('IdPlanInspeccion', 'desc')
            ->leftjoin('dbo.AU_Reg_Auditorias as a', 'dbo.AU_Reg_PlanesInspeccion.IdAuditoria', '=', 'a.IdAuditoria')
            ->leftjoin('dbo.AU_Reg_usersLDAP as ul', 'ul.IdUserLDAP', '=', 'a.IdPersonalAudi')

            ->select('dbo.AU_Reg_PlanesInspeccion.IdPlanInspeccion', 
               'a.Codigo', 'dbo.AU_Reg_PlanesInspeccion.Fecha', 
               'ul.name as InspeccIonado',
                'dbo.AU_Reg_PlanesInspeccion.Observaciones')
