...
class InformeCursosFuncionarioController extends Controller
{
    ...
    {
        $cursos = VWCursosPersonal::where('IdPersonal','=',$IdPersonal)->get();
        return view ('gestionRecursos.capacitacionPersonalSecad.informes.visual_informe_cursos_funcionarios')
                ->with('cursos', $cursos);
    }
