...
class ActividadesInspeccion extends Model
{
	...
	public static function getActividadesPlan($IdPlanInspeccion){
		return \DB::table('dbo.AU_Reg_ActividadesPlanInspeccion as ac')
             ...
             ->leftjoin('AU_Reg_usersLDAP as uli','ac.IdPersonalInspector', 'uli.IdUserLDAP')
               ->leftJoin('AU_Reg_ProcesosAuditorias as P','ac.idproceso','P.IdProceso') 
				->select('P.Proceso','ac.IdActividadPlanIns','ac.Actividades','cr.Norma', 'ul.Name','uli.name as inspector' ,'ac.FechaInicio', 'ac.HoraInicio', 'ac.FechaCierre', 'ac.HoraFinal')
