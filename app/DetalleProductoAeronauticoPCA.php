...
class DetalleProductoAeronauticoPCA extends Model
{

protected $table = 'AU_Reg_DetalleProductoAeronauticoPCA';
...
/*    public function demandaPotencial(){
  ...
  /*  public static function demandaPotencialAll(){
        return DetalleProductoAeronauticoPCA::join('AU_Mst_Unidades','AU_Mst_Unidades.IdUnidad', '=', 'AU_Reg_DemandaPotencial.IdUnidad')
                                ->get();
    }*/
