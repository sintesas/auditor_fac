...
class Anotacion extends Model
{
    ...
    public static function getAnotacionesByUser($IdPersonal, $name = null){
        ...
        $sql = "select anotacion.IdAnotacion,
anotacion.IdAuditoria,
anotacion.NoAnota,
anotacion.IdTipoAnotacion,
anotacion.Fecha,
anotacion.IdFuentesAnotacion,
anotacion.IdActividadPlanInspeccion,
anotacion.IdClaseAnotacion,
anotacion.IdEnUnaAnotacion,
anotacion.DescripcionEvidencia,
anotacion.IdProceso,
anotacion.IdSubProceso,
anotacion.Plazo,
anotacion.IdProgramaCalidad,
anotacion.Correccion,
anotacion.IdCriticidadAnotacion,
anotacion.AuditoriaAnterior,
anotacion.IdResponsableAprobacion,
temacatalogacion.temacatalogacion,
codigotema.codigotema
anotacion.EstadoInsertOrganizacion, auditoria.*, userldp.*, tipoAnotacion.*
              ...
              left join temacatalogacion as temacatalogacion  on temacatalogacion.idtemacatalogacion=anotacion.temacatalogacionid
  left join codigotema as codigotema  on codigotema.idcodigotema=anotacion.codigotemaid
    ...
    public static function getAllAnotaciones(){
        return Anotacion::leftjoin('AU_Mst_TiposAnotacion as tipo','tipo.IdTipoAnotacion','=', 'AU_Reg_Anotaciones.IdTipoAnotacion')
                            ...
                            ->leftjoin('temacatalogacion as temacatalogacion' , 'temacatalogacion.idtemacatalogacion', '=' ,'AU_Reg_Anotaciones.temacatalogacionid')
                             ->leftjoin('codigotema as codigotema' , 'codigotema.idcodigotema', '=' ,'AU_Reg_Anotaciones.codigotemaid') 
                            ->get();
    }
}
