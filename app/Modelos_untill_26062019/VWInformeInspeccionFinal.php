...
class VWInformeInspeccionFinal extends Model
{
    ...
    public static function getDataAuditoria($idAuditoria){
        ...
        return DB::table('AU_Reg_Auditorias as au')
            ->select('au.IdAuditoria','au.FechaInicio ','au.aspecto as Aspecto', 'au.NombreAuditoria','insp.Name as inspectorliderA', 'pr.Name as NombresResponsable', 'au.CargoRespo',
    ...
    public static function getDataActividades($idAuditoria){
        ...
        return DB::table('AU_Reg_Auditorias as au')
            ...
            ->leftjoin('AU_Reg_usersLDAP as uli', 'uli.IdUserLDAP' ,'=','ap.IdPersonalInspecto')
